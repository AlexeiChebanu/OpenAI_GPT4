...
namespace OpenAI.Models;
    ...
    public static Model Davinci => new Model("davinci") { OwnedBy = "openai" };
        ...
        /// Very capable, but faster and lower cost than Davinci.
        /// </summary>
        public static Model Curie => new Model("curie") { OwnedBy = "openai" };

        /// <summary>
        /// Capable of straightforward tasks, very fast, and lower cost.
        /// </summary>
        public static Model Babbage => new Model("babbage") { OwnedBy = "openai" };

        /// <summary>
        /// 	Capable of very simple tasks, usually the fastest model in the GPT-3 series, and lowest cost.
        /// </summary>
        public static Model Ada => new Model("ada") { OwnedBy = "openai" };
        ...
        /// </summary>
        public static Model GPT4_0314 => new Model("gpt-4-0314") { OwnedBy = "openai" };
        /// <summary>
        /// Same capabilities as the base gpt-4 mode but with 4x the context length. Will be updated with our latest model iteration.
        /// </summary>
        public static Model GPT_32k4 => new Model("gpt-4-32k") { OwnedBy = "openai" };
        /// <summary>
        ...
        /// </summary>
        public static Model GPT4_32k_0314 => new Model("gpt-4-32k-0314") { OwnedBy = "openai" };
        ...
        public async Task<Model> RetrieveModelDetailsAsync(OpenAI.OpenAIClient api)
        {
